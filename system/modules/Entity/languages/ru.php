<?php
return array(
    'module_entity' => 'Поля для форм',
    'module_entity_description' => 'Предоставляет api для создания полей форм, вроде текста, картинок, списка',
    'field_not_exists' => 'Поле {name} не существует',

    'field_text' => 'Текст',
    'field_text_description' => 'В одну строку или несколько',
    'field_images' => 'Изображение',
    'field_images_description' => 'Позволяет выбрать несколько картинок с сервера или загрузить с компьютера',
    'field_map' => 'Карта',
