<div class="card box">
    <div class="card-block">
        ...
        <div class="row">
            <div class="col-sm-6">
                <?=H::formGroup(t('site_name'), Form::field('Text', 'name'));?>
            </div>
            <div class="col-sm-6">
                <?=H::formGroup(t('site_theme'), Form::field('List', 'theme', null, ['items' => $themes]));?>
            </div>
            <div class="col-sm-6">
                <?=H::formGroup(t('site_domains'), Form::field('TextList', 'domains'), t('one_per_line'));?>
            </div>
            <div class="col-sm-6">
                <?=H::formGroup(t('site_use_only_main_domain'), Form::field('YesNo', 'onlyMainDomain'));?>
            </div>
            <div class="col-sm-6">
                <?=H::formGroup(t('site_locales'), Form::field('TextList', 'locales'), t('one_per_line'));?>
            </div>
            <div class="col-sm-6">
